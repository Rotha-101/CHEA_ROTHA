  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          <h3 className="text-lg sm:text-2xl font-display font-bold text-zinc-900 dark:text-white group-hover:text-[#ff4d4d] transition-colors">
            {edu.degree} in {edu.field}
          </h3>
          <p className="mt-1 text-sm sm:text-lg text-zinc-600 dark:text-zinc-400 font-medium">{edu.institution}</p>
        </div>
