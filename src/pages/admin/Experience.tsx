          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              <div className="sm:col-span-3">
                ...
                <input type="text" {...register('title', { required: true })} className="mt-1 block w-full sm:text-sm border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-md px-3 py-2 focus:ring-[#ff4d4d] focus:border-[#ff4d4d]" />
              </div>
              <div className="sm:col-span-3">
                <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Company</label>
                <input type="text" {...register('company', { required: true })} className="mt-1 block w-full sm:text-sm border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-md px-3 py-2 focus:ring-[#ff4d4d] focus:border-[#ff4d4d]" />
              </div>
              <div className="sm:col-span-3">
                <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Location</label>
                <input type="text" {...register('location')} className="mt-1 block w-full sm:text-sm border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-md px-3 py-2 focus:ring-[#ff4d4d] focus:border-[#ff4d4d]" />
              </div>
              <div className="sm:col-span-3">
              ...
              <div className="sm:col-span-2">
                ...
                <input type="text" placeholder="e.g., Jan 2020" {...register('startDate', { required: true })} className="mt-1 block w-full sm:text-sm border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-md px-3 py-2 focus:ring-[#ff4d4d] focus:border-[#ff4d4d]" />
              </div>
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">End Date</label>
                <input type="text" placeholder="e.g., Dec 2022" disabled={isCurrent} {...register('endDate')} className="mt-1 block w-full sm:text-sm border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-md px-3 py-2 focus:ring-[#ff4d4d] focus:border-[#ff4d4d] disabled:opacity-50" />
              </div>
              <div className="sm:col-span-2 flex items-center mt-6">
                <input type="checkbox" id="current_exp" {...register('current')} className="h-4 w-4 text-[#ff4d4d] focus:ring-[#ff4d4d] border-zinc-300 rounded" />
              ...
              <div className="sm:col-span-6">
                ...
                <textarea rows={4} {...register('description', { required: true })} className="mt-1 block w-full sm:text-sm border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-md px-3 py-2 focus:ring-[#ff4d4d] focus:border-[#ff4d4d]" />
              </div>
            ...
            <div className="flex justify-end gap-3">
              ...
              <button type="submit" className="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-zinc-950 bg-[#ff4d4d] hover:bg-[#ff4d4d] transition-colors">Save Experience</button>
            </div>
          </form>
        </div>
      )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">
                      ...
                      {exp.photos?.length > 0 && <span className="ml-2 text-[#ff4d4d]">📷 {exp.photos.length} photo{exp.photos.length > 1 ? 's' : ''}</span>}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <button onClick={() => handleEdit(exp)} className="p-2 text-zinc-400 hover:text-[#ff4d4d] transition-colors"><Edit2 className="h-4 w-4" /></button>
